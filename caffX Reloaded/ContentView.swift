...
struct ContentView: View {
    ...
    @State var isFirstLaunch = UserDefaults.standard.bool(forKey: "isFirstLaunch") == false
    
    let basicGraphTip = graphBasic()
    ...
    func processGoal() {
        let daysLeft = max(1, goalDate.timeIntervalSinceNow / 86400)
        print(daysLeft)
